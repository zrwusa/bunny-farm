...
export type CreateProductMutation = {
    createProduct: {
        ...
        skus: Array<{
            ...
            color: string,
            size: string,
            prices: Array<{ id: string, price: number, validFrom?: Date | null, validTo?: Date | null }>
        }>,
...
export type AddItemToCartMutation = {
    addToCart: {
        ...
        items: Array<{
            ...
            createdAt: Date,
            updatedAt: Date,
            product?: { name: string, images: Array<{ position?: number | null, url: string }> } | null,
            sku?: { size: string, color: string, images: Array<{ position?: number | null, url: string }> } | null
        }>,
...
export type CreateProductClientMutation = {
    createProduct: {
        id: string,
        name: string,
        description?: Record<string, unknown> | null,
...
export type PlaceOrderMutation = {
    placeOrder: {
        ...
        paymentMethod: PaymentMethod,
        shippingStatus: ShippingStatus,
        items?: Array<{ id: string, quantity: number, sku: { id: string, skuCode?: string | null } }> | null
    }
};
...
export type GetProductQuery = {
    product?: {
        ...
        skus: Array<{
            ...
            size: string,
            prices: Array<{ id: string, price: number, validFrom?: Date | null, validTo?: Date | null }>,
            inventories: Array<{ id: string, quantity: number, warehouse: { id: string, name: string } }>
        }>
    } | null
};
...
export type GetSelectedCartItemsQuery = {
...
export type MeQuery = {
    me: { id: string, email: string, profile?: { avatarUrl?: string | null, displayName?: string | null } | null }
};
 ...
 * });
 */
export function usePlaceDetailQuery(baseOptions: Apollo.QueryHookOptions<PlaceDetailQuery, PlaceDetailQueryVariables> & ({
    variables: PlaceDetailQueryVariables;
    skip?: boolean;
} | { skip: boolean; })) {
    const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useSuggestProductNamesQuery(baseOptions: Apollo.QueryHookOptions<SuggestProductNamesQuery, SuggestProductNamesQueryVariables> & ({
    variables: SuggestProductNamesQueryVariables;
    skip?: boolean;
} | { skip: boolean; })) {
    const options = {...defaultOptions, ...baseOptions}
